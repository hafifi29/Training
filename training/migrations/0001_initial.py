    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('universityvote_sd', models.DateTimeField(max_length=31, null=True)),
                ('universityvote_ed', models.DateTimeField(max_length=31, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('community', models.CharField(choices=[('1', 'اللجنة العلمية'), ('2', 'اللجنة الرياضية'), ('3', 'اللجنة الاجتماعية'), ('4', 'أسرة الجوالة و الخدمات'), ('5', 'اللجنة الثقافية'), ('6', 'اللجنة الفنية'), ('7', 'لجنة الاسر و الرحلات')], default='1', max_length=20)),
                ('rec_letter', models.FileField(upload_to='')),
                ('final_list', models.BooleanField(default=False)),
                ('role', models.CharField(choices=[('1', 'مترشح'), ('2', 'أمين لجنة'), ('3', 'أمين مساعد لجنة'), ('4', 'أمين اتحاد'), ('5', 'أمين مساعد اتحاد'), ('6', 'رئيس اتحاد'), ('7', 'نائب رئيس اتحاد')], default='', max_length=20)),
